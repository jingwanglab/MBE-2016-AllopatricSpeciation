...
java -jar $msms -ms 92 1 -t 154 -r 32.3 -I 2 48 44 -g 2 4.5105 -n 2 3.01 -ma x 0.1 0.4 x -ej 0.3781 2 1 > $OutDir/msms_run$1.$file.output
###2. run mstoglf 
$msToGlf -in $OutDir/msms_run$1.$file.output -out $OutDir/msms_run$1.$file.output -regLen 5000 -singleOut 1 -depth 20 -err 0.005
...
$angsd -glf $OutDir/tremula.$file.glf.gz -nInd 24 -doSaf 1 -out $OutDir/tremula.$file -fai $ref -isSim 1 -fold 1
$angsd -glf $OutDir/tremuloides.$file.glf.gz -nInd 22 -doSaf 1 -out $OutDir/tremuloides.$file -fai $ref -isSim 1 -fold 1
###4. 1dsfs and 2dsfs
