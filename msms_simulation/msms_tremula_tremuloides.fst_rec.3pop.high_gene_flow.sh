...
#SBATCH -A b2010014
#SBATCH -p core
#SBATCH -o msms_two_aspens.high_geneflow.out
#SBATCH -e msms_two_aspens.high_geneflow.err
#SBATCH -J msms_two_aspens.high_geneflow.job
#SBATCH -t 2-00:00:00
...
#OutDir="/proj/b2011141/nobackup/tremula_vs_tremuloides_paper/bwa_mem_alignment/ANGSD/msms_3pop_high_gene_flow/run$1"
OutDir="/proj/b2011141/nobackup/PaperII-MBE/bwa_mem_alignment/ANGSD/msms_3pop_high_gene_flow/run$1"
...
###Time of divergence of P.tremula and P.tremuloides, T=155494 generations, t=155494/4*102814=0.3781,here the best fit parameter to the observed data is the upper (95%) limit of the divergence time,which is 207568/4*102814
###N_tremuloides=309500,exponential growth rate=log(56235/309500)/0.3781
###N_tremuloides=309500,exponential growth rate=log(56235/309500)/0.51=3.344
###we also include the population substructure and gene flow between subpopulations in P. tremuloides here  
...
##time of population subpopulation is 0.11*15*4*102814=678572.4 years ago
#java -jar $msms -ms 92 1 -t 290 -r $recombination -I 3 48 24 20 -n 2 3.01 -n 3 3.01 -g 2 4.5105 -g 3 4.5105 -m 2 3 10 -m 3 2 10 -ej 0.11 3 2 -em 0.11 1 2 0.1 -em 0.11 2 1 0.4 -eg 0.11 2 4.5105 -ej 0.51 2 1 -en 0.51 1 0.5469 > $OutDir/msms_run$1.$file.output
java -jar $msms -ms 92 1 -t 290 -r $recombination -I 3 48 24 20 -n 2 3.01 -n 3 3.01 -g 2 3.344 -g 3 3.344 -m 2 3 10 -m 3 2 10 -ej 0.11 3 2 -em 0.11 1 2 0.1 -em 0.11 2 1 0.4 -eg 0.11 2 3.344 -ej 0.51 2 1 -en 0.51 1 0.5469 > $OutDir/msms_run$1.$file.output
###2. run mstoglf 
...
$splitgl $OutDir/msms_run$1.$file.output.glf.gz 46 25 36 > $OutDir/tremuloides.1.$file.glf.gz
$splitgl $OutDir/msms_run$1.$file.output.glf.gz 46 37 46 > $OutDir/tremuloides.2.$file.glf.gz
...
$angsd -glf $OutDir/tremuloides.1.$file.glf.gz -nInd 12 -doSaf 1 -out $OutDir/tremuloides.1.$file -fai $ref -isSim 1 
$angsd -glf $OutDir/tremuloides.2.$file.glf.gz -nInd 10 -doSaf 1 -out $OutDir/tremuloides.2.$file -fai $ref -isSim 1 
###4. 1dsfs and 2dsfs
...
$realSFS $OutDir/tremuloides.1.$file.saf.idx > $OutDir/tremuloides.1.$file.sfs
$realSFS $OutDir/tremuloides.2.$file.saf.idx > $OutDir/tremuloides.2.$file.sfs
$realSFS $OutDir/tremuloides.1.$file.saf.idx $OutDir/tremuloides.2.$file.saf.idx > $OutDir/tremuloides.$file.ml
...
$realSFS fst index $OutDir/tremuloides.1.$file.saf.idx $OutDir/tremuloides.2.$file.saf.idx -sfs $OutDir/tremuloides.$file.ml -fstout $OutDir/tremuloides.run$1.$file
###6. get the global estimate of fst
$realSFS fst stats $OutDir/tremuloides.run$1.$file.fst.idx >> $OutDir/tremuloides.run$1.global.fst
...
$angsd -glf $OutDir/tremuloides.1.$file.glf.gz -nInd 12 -doSaf 1 -doThetas 1 -anc $anc -fai $ref -pest $OutDir/tremuloides.1.$file.sfs -out $OutDir/tremuloides.1.$file -isSim 1
$angsd -glf $OutDir/tremuloides.2.$file.glf.gz -nInd 10 -doSaf 1 -doThetas 1 -anc $anc -fai $ref -pest $OutDir/tremuloides.2.$file.sfs -out $OutDir/tremuloides.2.$file -isSim 1
...
$thetaStat make_bed $OutDir/tremuloides.1.$file.thetas.gz
$thetaStat do_stat $OutDir/tremuloides.1.$file.thetas.gz -nChr 12

$thetaStat make_bed $OutDir/tremuloides.2.$file.thetas.gz
$thetaStat do_stat $OutDir/tremuloides.2.$file.thetas.gz -nChr 10
