...
#SBATCH -A b2010014
#SBATCH -p core
#SBATCH -o msms_two_aspens.rec_free.out
#SBATCH -e msms_two_aspens.rec_free.err
#SBATCH -J msms_two_aspens.rec_free.job
#SBATCH -t 2-00:00:00
...
OutDir="/proj/b2011141/nobackup/PaperII-MBE/bwa_mem_alignment/ANGSD/msms/run$1"
...
java -jar $msms -ms 92 1 -t 290 -r $recombination -I 2 48 44 -n 2 3.01 -g 2 3.344 -ma x 0.2 0.8 x -ej 0.51 2 1 -en 0.51 1 0.5469 > $OutDir/msms_run$1.$file.output
###2. run mstoglf 
