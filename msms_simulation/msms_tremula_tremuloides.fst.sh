...
OutDir="/proj/b2011141/nobackup/tremula_vs_tremuloides_paper/bwa_mem_alignment/ANGSD/msms_no_rec/run$1"
...
#java -jar $msms -ms 92 1 -t 250  -r 32.3 -I 2 48 44 -n 2 3.01 -g 2 4.5105 -ma x 0.1 0.4 x -en 0.3781 1 0.5469 -ej 0.3781 2 1 > $OutDir/msms_run$1.$file.output
java -jar $msms -ms 92 1 -t 290 -r 32.3 -I 2 48 44 -n 2 3.01 -g 2 4.5105 -ma x 0.1 0.4 x -en 0.51 1 0.5469 -ej 0.51 2 1 > $OutDir/msms_run$1.$file.output
###2. run mstoglf 
$msToGlf -in $OutDir/msms_run$1.$file.output -nind 46 -out $OutDir/msms_run$1.$file.output -regLen 10000 -singleOut 1 -depth 20 
