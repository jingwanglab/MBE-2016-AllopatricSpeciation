...
#OutDir="/proj/b2011141/nobackup/tremula_vs_tremuloides_paper/bwa_mem_alignment/ANGSD/msms_3pop/run$1"
OutDir="/proj/b2011141/nobackup/PaperII-MBE/bwa_mem_alignment/ANGSD/msms_3pop/run$1"
...
###Time of divergence of P.tremula and P.tremuloides, T=155494 generations, t=155494/4*102814=0.3781,here the best fit parameter to the observed data is the upper (95%) limit of the divergence time,which is 207568/4*102814=0.51
...
###we also include the population substructure in P. tremuloides here  t=200000/15*4*102814=0.0324
...
#java -jar $msms -ms 92 1 -t 290 -r $recombination -I 3 48 24 20 -n 2 3.01 -n 3 3.01 -g 2 4.5105 -g 3 4.5105 -m 2 3 0 -m 3 2 0 -ej 0.03 3 2 -em 0.03 1 2 0.1 -em 0.03 2 1 0.4 -eg 0.03 2 4.5105 -ej 0.51 2 1 -en 0.51 1 0.5469 > $OutDir/msms_run$1.$file.output
java -jar $msms -ms 92 1 -t 290 -r $recombination -I 3 48 24 20 -n 2 3.01 -n 3 3.01 -g 2 3.344 -g 3 3.344 -m 2 3 0 -m 3 2 0 -ej 0.03 3 2 -em 0.03 1 2 0.1 -em 0.03 2 1 0.4 -eg 0.03 2 3.344 -ej 0.51 2 1 -en 0.51 1 0.5469 > $OutDir/msms_run$1.$file.output
###2. run mstoglf 
