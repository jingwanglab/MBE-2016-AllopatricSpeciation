...
#$angsd -bam $bam_list_tremula -GL 1 -doMajorMinor 5 -anc $ref -doMaf 2 -doPlink 2 -doGeno 3 -doPost 1 -postCutoff 0.99 -SNP_pval 1e-6 -geno_minDepth 4 -out $OutDir/tremula.chr$1 -ref $ref -rf $chr -minMapQ 30 -minQ 20 -doCounts 1 
