...
OutDir="/proj/b2011141/nobackup/tremula_vs_tremuloides_paper/bwa_mem_alignment/ANGSD/ancestral_major/tremuloides/Chr$1"
...
$angsd -bam $bam_list_tremuloides -GL 1 -doMajorMinor 5 -doMaf 2 -anc $ref -out $OutDir/tremuloides_chr$1.maf -minMapQ 30 -minQ 20 -rf $chr
