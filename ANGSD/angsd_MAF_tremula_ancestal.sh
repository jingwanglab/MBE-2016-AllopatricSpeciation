...
#SBATCH -A b2010014
#SBATCH -p core
#SBATCH -o angsd_MAF_tremula.out
#SBATCH -e angsd_MAF_tremula.err
#SBATCH -J angsd_MAF_tremula.job
#SBATCH -t 1-00:00:00
...
OutDir="/proj/b2011141/nobackup/tremula_vs_tremuloides_paper/bwa_mem_alignment/ANGSD/ancestral_major/tremula/Chr$1"
...
$angsd -bam $bam_list_tremula -GL 1 -doMajorMinor 5 -doMaf 2 -anc $ref -out $OutDir/tremula_chr$1.maf -minMapQ 30 -minQ 20 -rf $chr
