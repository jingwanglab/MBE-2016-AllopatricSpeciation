...
OutDir="/proj/b2011141/nobackup/tremula_vs_tremuloides_paper/bwa_mem_alignment/ANGSD/plink/tremuloides/Chr$1"
...
$angsd -bam $bam_list_tremuloides -GL 1 -doMajorMinor 1 -doMaf 2 -doPlink 2 -doGeno -4 -doPost 1 -postCutoff 0.99 -SNP_pval 1e-6 -geno_minDepth 4 -out $OutDir/tremuloides.$1 -ref $ref -rf $chr -minMapQ 30 -minQ 20 -doCounts 1 
